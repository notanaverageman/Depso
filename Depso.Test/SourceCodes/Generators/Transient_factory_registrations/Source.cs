...
public partial class Provider
{
    ...
    private void RegisterServices()
    {
        ...
        AddTransient(x => new System.Exception());
        AddTransient(x => new List<IDisposable>());
        AddTransient<InterfaceC>(x => (InterfaceC)x.GetService(typeof(Service2)));
        AddTransient(Func);
        AddTransient(GetService2).AlsoAs<Interface2>().AlsoAs<InterfaceB>();
