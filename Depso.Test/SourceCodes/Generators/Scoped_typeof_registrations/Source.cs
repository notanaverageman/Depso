...
public partial class Provider
{
    ...
    {
        AddScoped(typeof(Interface1), typeof(Service1)).AlsoAsSelf();
        AddScoped(typeof(InterfaceA), typeof(Service1));
        AddScoped(typeof(Service2)).AlsoAs(typeof(Interface2)).AlsoAs(typeof(InterfaceB));
        AddScoped(typeof(Service2));
    }
}